...
class ReadMgf():
    ...
    def get_dec_input(self):
        ...
        return tf.ragged.constant(dec_input).to_tensor(default_value=0)
...
def tokenize_seq(seq_input, charge_input): # sequence 를 하나씩 처리함
    # get string ( sequence ) as input
    # output is 3-dimensional array, [batch, num_digestion, 3]
